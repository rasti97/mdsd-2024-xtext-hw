 ...
 *   <li>{@link statemachine.model.impl.MachineImpl#getFields <em>Fields</em>}</li>
...
public class MachineImpl extends MinimalEObjectImpl.Container implements Machine {
	...
	public EList<Field> getFields() {
		if (fields == null) {
			fields = new EObjectContainmentEList<Field>(Field.class, this, ModelPackage.MACHINE__FIELDS);
		}
		return fields;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.MACHINE__FIELDS:
