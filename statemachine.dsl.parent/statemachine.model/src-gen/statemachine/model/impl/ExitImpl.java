 ...
 * </p>
 * <ul>
 *   <li>{@link statemachine.model.impl.ExitImpl#getCommands <em>Commands</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExitImpl extends MinimalEObjectImpl.Container implements Exit {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.EXIT;
	}
	...
	public EList<Command> getCommands() {
		if (commands == null) {
			commands = new EObjectContainmentEList<Command>(Command.class, this, ModelPackage.EXIT__COMMANDS);
		}
		return commands;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.EXIT__COMMANDS:
