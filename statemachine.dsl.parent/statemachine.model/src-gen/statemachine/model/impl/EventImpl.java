 ...
 * </p>
 * <ul>
 *   <li>{@link statemachine.model.impl.EventImpl#getName <em>Name</em>}</li>
 *   <li>{@link statemachine.model.impl.EventImpl#getCommands <em>Commands</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EventImpl extends MinimalEObjectImpl.Container implements Event {
	...
	public EList<Command> getCommands() {
		if (commands == null) {
			commands = new EObjectContainmentEList<Command>(Command.class, this, ModelPackage.EVENT__COMMANDS);
		}
		return commands;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.EVENT__COMMANDS:
