...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ModelPackage.JUMP: {
				Jump jump = (Jump)theEObject;
				T result = caseJump(jump);
				if (result == null) result = caseCommand(jump);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case ModelPackage.FIELD_REFERENCE: {
				...
				if (result == null) result = casePrintArgument(fieldReference);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ModelPackage.INCREMENT_FIELD: {
				IncrementField incrementField = (IncrementField)theEObject;
				T result = caseIncrementField(incrementField);
				if (result == null) result = caseCommand(incrementField);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Increment Field</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Increment Field</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIncrementField(IncrementField object) {
		return null;
	}
